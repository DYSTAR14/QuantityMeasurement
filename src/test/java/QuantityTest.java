...
public class QuantityTest {
    ...
    public void given0Centimeterand0Centimeter_ShouldReturnEqual() {
        ...
        Length centimeter2 = new Length(Unit.CENTIMETER, 0.0);
    ...
    public void givenCompare30_48CentimeterAnd1Feet_ShouldReturnEqual() {
        Length centimeter1 = new Length(Unit.CENTIMETER, 30.48);
        Length feet1 = new Length(Unit.FEET, 1.0);
    ...
    public void givenCompare91_44CentimeterAnd1Yard_ShouldReturnEqual() {
        Length centimeter1 = new Length(Unit.CENTIMETER, 91.44);
        Length yard1 = new Length(Unit.YARD, 1.0);
    ...
    public void givenCompare1CentimeterAnd36Inch_ShouldReturnEqual() {
        Length centimeter1 = new Length(Unit.CENTIMETER, 2.54);
        Length inch1 = new Length(Unit.INCH, 1.0);
    ...
    public void givenAdd2InchAnd2_54_CentimeterShouldSuccess(){
        Length inch1 = new Length(Unit.INCH, 2.0);
        Length inch2 = new Length(Unit.CENTIMETER, 2.54);
        double actual = Length.add(inch1,inch2);
        double expected = 3.0;
        Assertions.assertEquals(actual,expected);
    }
